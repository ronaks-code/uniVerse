...
//   caretUpIcon: "cursor-pointer mr-1 mt-2 text-[1.0rem]",
//   heartOutlineIcon: "cursor-pointer mr-1 mt-2 text-[1.0rem]",
//   heartFillIcon: "cursor-pointer mr-1 mt-2 text-[1.0rem]",
//   courseCard: "cursor-pointer bg-gray-400 rounded-md px-2 py-1 font-semibold mt-2 w-screen overflow-hidden overflow-ellipsis max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl",
// };
